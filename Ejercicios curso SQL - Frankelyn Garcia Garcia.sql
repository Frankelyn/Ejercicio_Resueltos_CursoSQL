...
--4- Ingrese un registro con código repetido (aparece un mensaje de error)
  ...
  insert into libros (codigo,titulo,autor,editorial) values (1,'Don quijote','Miguel Cervantes','Emece'); 

--5- Intente ingresar el valor "null" en el campo "codigo"

   insert into libros (codigo,titulo,autor,editorial) values (null,'Don quijote','Miguel Cervantes','Emece')
...
--6- Intente ingresar un registro con un valor para el campo "codigo"
 ...
 insert into medicamentos (codigo, nombre, laboratorio,precio,cantidad) values(15, 'Aspirina 500','Bayer',25.10,100);

--7- Intente actualizar un valor de código (aparece un mensaje de error)

 Update medicamentos set codigo = 5 where codigo = 1
...
--6- Intente actualizar el codigo de una película (aparece un mensaje de error)
 ...
 update peliculas set codigo = 7 where codigo = 1
...
--8- Ingrese un nuevo registro.
  ...
  insert into peliculas (titulo,actor,duracion) values('Mentiroso Mentiroso','Jim Carrey',120);
...
--5- Intente ingresar un registro con un valor para el campo "codigo".
 ...
 insert into medicamentos (codigo, nombre, laboratorio,precio,cantidad) values(7,'Amoxidal 500','Bayer',15.60,100)
...
--8- Ingrese un nuevo registro con valor para el campo "codigo" repetido.
 ...
 insert into medicamentos (codigo, nombre, laboratorio,precio,cantidad) values(1,'Aspirina 500','Bayer',25.60,100)
...
--Primer problema:
 ...
 select * from medicamentos where laboratorio='Roche' or
  precio<5;
